...
LDFLAGS := -X 'github.com/alaxay8/khelper/cmd.Version=$(VERSION)' -X 'github.com/alaxay8/khelper/cmd.Commit=$(COMMIT)' -X 'github.com/alaxay8/khelper/cmd.BuildDate=$(DATE)'
